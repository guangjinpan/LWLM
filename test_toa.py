...
EnvPara["fstride"]  = 4
EnvPara["tstride"]  = 4
EnvPara["task"]  = "inference_toa" 
EnvPara["load_pretrained_mdl_path"] =  '../../pretrained_model/toa/mix/nofrozen/10000/testepoch=602.ckpt' 
EnvPara["save_result_file"] = 'TOA-mix-10M-10000-vvx0'
...
if __name__ == '__main__':   
    ...
    for  channel_Antenna_subcarrier_aa, channel_Antenna_subcarrier_ri, channel_delay_angle_ri, UElocation_all, BSconf_all in test_dataloader:
        ...
        label[cnt : cnt+len(channel_Antenna_subcarrier_aa),0] = UElocation_all[:,0, 2].cpu().detach().numpy() * 100
